...
import { z } from 'zod';
import { CommentResponseSchema, type CommentResponseDto } from '../board/dto';
...
import type { BoardActionType, SortOrder, UserPayload } from '../common/types';
